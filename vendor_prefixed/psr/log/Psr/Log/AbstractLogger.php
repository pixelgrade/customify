 ...
 */
abstract class AbstractLogger implements \Pixelgrade\Customify\Vendor\Psr\Log\LoggerInterface
{
    /**
     * System is unusable.
     *
    ...
    {
        $this->log(\Pixelgrade\Customify\Vendor\Psr\Log\LogLevel::EMERGENCY, $message, $context);
    }
    /**
