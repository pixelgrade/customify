...
class AbstractPluginTest extends \Customify\Vendor\PHPUnit\Framework\TestCase
{
    ...
    {
        return $this->getMockBuilder('Customify\\Vendor\\Cedaro\\WP\\Plugin\\AbstractPlugin')->getMockForAbstractClass();
    }
}
