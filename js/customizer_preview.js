	...
	function( $, window, document, undefined ) {
		...
		$( document ).ready( function() {
			...
			const get_CSS_values = function( ID, values ) {
				...
				if ( typeof values.font_size !== 'undefined' && typeof values.modular_scale === 'undefined' ) {
        ...
        if ( typeof values.modular_scale !== 'undefined' ) {
          store['font-size'] = 'var(--theme-ms-' + values.modular_scale + '-font-size)';
        }
