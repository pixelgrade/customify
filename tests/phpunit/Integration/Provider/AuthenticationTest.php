...
namespace Customify\Tests\Integration\Provider;

use Pimple\ServiceIterator;
use Customify\Capabilities as Caps;
use Customify\Exception\AuthenticationException;
use Customify\HTTP\Request;
use Customify\Provider\Authentication;
use Customify\Tests\Integration\TestCase;
use WP_Error;

use function Patchwork\{always, redefine, restore};
use function Customify\get_packages_permalink;
