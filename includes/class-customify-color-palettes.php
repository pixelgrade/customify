...
//			plugins_url( 'js/customizer/color-palettes' . $suffix . '.js', PixCustomifyPlugin()->get_file() ),
	...
	public function add_style_manager_new_section_master_colors_config( $config ) {
		...
		$config['sections']['style_manager_section']['options'] = array(
		      ...
		      'sm_color_space' => array(
			      'type'         => 'select',
			      'live'         => true,
			      'default'      => 'lch',
			      'setting_type' => 'option',
		          'setting_id'   => 'sm_color_space',
			      'label'        => esc_html__( 'Color Space', '__theme_txtd' ),
			      'choices'      => array(
			      	'rgb' => 'RGB',
			      	'hsl' => 'HSL',
			      	'lab' => 'LAB',
		      ...
		      'sm_use_color_sources' => array(
                  'type'         => 'checkbox',
                  'live'         => true,
                  'default'      => true,
                  'setting_type' => 'option',
                  'setting_id'   => 'sm_use_color_sources',
                  'label'        => esc_html__( 'Use Sources', '__theme_txtd' ),
		      ),
		      'sm_color_interpolation' => array(
                  'type'         => 'checkbox',
                  'live'         => true,
                  'default'      => false,
                  'setting_type' => 'option',
                  'setting_id'   => 'sm_color_interpolation',
                  'label'        => esc_html__( 'Color Interpolation', '__theme_txtd' ),
		      ),
		      'sm_bezier_interpolation' => array(
                  'type'         => 'checkbox',
                  'live'         => true,
                  'default'      => false,
                  'setting_type' => 'option',
                  'setting_id'   => 'sm_bezier_interpolation',
                  'label'        => esc_html__( 'Bezier Interpolation', '__theme_txtd' ),
		      ),
	...
	public function add_current_palette_control( $config ) {
		...
		$current_palette .= '<div class="c-color-palette__notification  description  hidden  js-altered-notification">' . "\n" .
		                    wp_kses( __( 'One or more colors connected to your color palette have been modified. By changing or altering the current palette you will lose changes made prior to this action.', 'customify' ), array(
			                    'em'     => array(),
			                    'b'      => array(),
			                    'strong' => array(),
			                    'i'      => array()
